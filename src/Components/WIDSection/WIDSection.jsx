  ...
  return (
    <Section className="what-i-do" title="What I Do">
      <div className="card-wrapper three-col-layout">
        <Card imageComponent={<DesignIcon />} title="Design">
          <p>
        ...
        <Card imageComponent={<DevelopmentIcon />} title="Development">
          <p>
        ...
        <Card imageComponent={<PerformanceIcon />} title="Accessibility">
          <p>
